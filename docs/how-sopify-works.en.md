...
| Cursor | BASELINE_SUPPORTED | `install.sh --target cursor` | IDE user Plugin + global Skills/payload + user hooks; observable IDE baseline evidence, CLI invokes Skills manually |
